...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", help="Fraudulent Domain Text Format URL")
    parser.add_argument("--vendor", help="Fraudulent Domain Provider")
    parser.add_argument("--product", help="Fraudulent Domain Service")
